...
ServerEvents.recipes(event => {
    ...
    event.shaped(Item.of('tfmg:steel_ingot', 1), ['   ',' AA',' AA'],{ A: 'immersiveengineering:ingot_steel'});
    event.shaped(Item.of('immersiveengineering:ingot_steel', 1), ['   ',' AA',' AA'],{ A: 'tfmg:steel_ingot'});
